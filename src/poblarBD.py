...
def createUser():
    ...
    usuarios = [User("fran","fran","francisco","velloso","rucontra@gmail.com",1111,"usuario nuevo"),
                User("juani","juani","juana","maldonado","juahni@gmail.com",2222,"usuario nuevo"),
                User("romi","romi","romina","diaz de bedoya","romi@gmail.com",3333,"usuario nuevo"),
                User("juan","juan","juan","gonzalez","jgonza@gmail.com",4444,"usuario nuevo")]
...
def createTipoDeAtrib():
    ...
    from mgrTipoDeAtrib import MgrTipoDeAtrib
